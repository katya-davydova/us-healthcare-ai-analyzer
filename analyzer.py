...
==========================================
Вводишь данные любой healthcare-компании → получаешь реальный AI-анализ от Claude.

Как запустить:
1. Установи библиотеку: pip install anthropic
2. Запусти: python analyzer.py
"""
...
def get_company_data() -> tuple[str, str]:
    print("\nВведи данные о компании. Чем больше деталей — тем точнее анализ.\n")
    company_name = input("Название компании: ").strip()
    if not company_name:
        company_name = "Healthcare Company"

    print("\nОпиши компанию (тип, размер, локация, специализация, пациенты и т.д.):")
    print("(Нажми Enter дважды когда закончишь)\n")
...
def main():
    ...
    print("\nВыбери режим:")
    print("  1 — Ввести данные своей компании")
    print("  2 — Пример: Clinic (Hillcrest Internal Medicine, Dallas TX)")
    print("  3 — Пример: Telehealth Startup (MindBridge Health)")
    print("  4 — Пример: Insurance Provider (BlueStar Health Plans)")

    choice = input("\nТвой выбор (1/2/3/4): ").strip()
